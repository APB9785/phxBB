defmodule PhxBb.BoardsTest do
  ...
  describe "boards" do
    ...
    @valid_attrs %{description: "some description", name: "some name", security: 42}
    @update_attrs %{description: "some updated description", name: "some updated name", security: 43}
    @invalid_attrs %{description: nil, name: nil, security: nil}
  ...
  describe "boards" do
    ...
    @valid_attrs %{board_id: 42, category: 42, description: "some description", name: "some name", security: 42}
    @update_attrs %{board_id: 43, category: 43, description: "some updated description", name: "some updated name", security: 43}
    @invalid_attrs %{board_id: nil, category: nil, description: nil, name: nil, security: nil}
